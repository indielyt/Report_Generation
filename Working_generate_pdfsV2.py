...
# Source directory
#path = r'P:\Studies\158571_MTBeaverhead\17-08-0252S\Deliverables\Survey\20170531_Submittal\10020002\Photos'
# Production directory
#path = r'C:\Users\Daniel.Aragon\Desktop\TEMP\beaverhead_appendixF\Photos'
...
def get_images(current_directory, directory_exclusion=['XS_Photos'], image_extension=['.jpg', '.JPG'], image_exclusion=['.Thumbs']):
    ...
    if len(images) > 0:
        ...
        def generate_pdf(filepath, images):
            ...
            style.add(ParagraphStyle(name='Justify', alignment = TA_CENTER))
            ...
            for image in images:
                ...
                story.append(size_image(img_path,width=1*cm))
